  ...
  try {
    ...
    const handleSummarize = async (prompt: string) => {
      ...
      try {
        ...
        console.log('AI Summarize triggered, API Key present:', !!apiKey);
    ...
    console.log('App rendering, authLoading:', authLoading, 'user:', user?.id);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-red-50 p-6">
        <div className="max-w-md w-full bg-white rounded-3xl p-8 shadow-xl text-center">
          <h1 className="text-2xl font-bold text-red-600 mb-4">Kritischer Fehler</h1>
          <p className="text-gray-600 mb-6">Die Anwendung konnte nicht geladen werden.</p>
          <pre className="text-left bg-gray-100 p-4 rounded-lg text-xs overflow-auto max-h-40 mb-6">
